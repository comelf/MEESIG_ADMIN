      ...
      function showDialog() {
        win = editor.windowManager.open({
          ...
          body: [
            ...
            {type: 'textbox', name: 'des',  label: ed.translate('Image description')},
        ...
        form = createElement('form', {
          action: ed.getParam("uploadimage_form_url", "/media/menuPhotoUpload"),
          target: iframe._id,
          method: "POST",
      ...
      function handleResponse(ret) {
        try {
          ...
          if(json["error"]) {
            ...
            ed.execCommand('mceInsertRawHTML', false, buildHTML(json));
