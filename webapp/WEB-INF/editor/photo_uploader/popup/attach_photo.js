	...
	var mMultipleUploadPath = '/media/multiplePhotoUpload';
	var mPhotoUploadPath 	= '/media/photoUpload';
    ...
    function html5Upload() {	
    	...
    	sUploadURL= mMultipleUploadPath; 	//upload URL
