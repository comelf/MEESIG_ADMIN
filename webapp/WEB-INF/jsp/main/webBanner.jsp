...
<body>
	 <div id="page-wrapper">
            ...
            <div class="container-fluid">
      		...
      		<input type="text" id="banner-type" class="hidden" value="1">
      		<form id="form-banner" role="form" action="/main/webbanner/create" method="post" >
	      		<div class="row banner-row">
	      			<c:forEach var="banner" items="${webBanners}">
	      				<div class="col-lg-12">
