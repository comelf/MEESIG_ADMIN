                ...
                <div class="row">
                	<form:form modelAttribute="user" role="form" action="/user/edit" method="post">
                		<div class="col-lg-5">
							...
							<div class="form-group">
							    <label>생년월일</label>
							    <fmt:formatDate value="${user.user_b_date }" type="date" pattern="yyyy-MM-dd" var="formattedBDate" />
							    <form:input path="user_b_date" type="text" cssClass="form-control" placeholder="Disabled" disabled="true" value="${formattedBDate }"/>
							</div>
							<div class="form-group">
							    <label>가입일</label>
							    <fmt:formatDate value="${user.user_join_date }" type="date" pattern="yyyy-MM-dd HH:mm:ss" var="theFormattedJDate" />
							    <form:input path="user_join_date" type="text" cssClass="form-control" placeholder="Disabled" disabled="true" value="${theFormattedJDate }"/>
							</div>
							<div class="form-group">
							    <label>탈퇴여부</label>
